...
namespace POE1.Models
{
    public class ProductDisplayModel
    {
        ...
        public ProductDisplayModel(int id, decimal price, string category, bool availability)
        {
            ProductID = id;
            ProductPrice = price;
        ...
        public static List<ProductDisplayModel> SelectProducts()
        {
            ...
            string con_string = "Server=tcp:jesse-weeder-sql-server.database.windows.net,1433;Initial Catalog=jesse-weeder-db;Persist Security Info=False;User ID=Jesse;Password=082Minute;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30";
            using (SqlConnection con = new SqlConnection(con_string))
            {
                string sql = "SELECT productID, price, category, availability FROM productTable";
                ...
                while (reader.Read())
                {
                    ...
                    product.ProductCategory = Convert.ToString(reader["category"]);
